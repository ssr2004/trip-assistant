...
class TravelAgent:
    ...
    def _build_execution_trace(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "intent_prompt_id": intent_metadata.get("prompt_id") or "",
            "intent_prompt_version": intent_metadata.get("prompt_version") or "",
            "intent_llm_output_quality_passed": bool(intent_metadata.get("llm_output_quality_passed")),
            "intent_llm_output_quality_issue_count": int(intent_metadata.get("llm_output_quality_issue_count") or 0),
            ...
            "llm_planner_prompt_id": planner_metadata.get("llm_planner_prompt_id") or "",
            "llm_planner_prompt_version": planner_metadata.get("llm_planner_prompt_version") or "",
            "llm_planner_output_quality_passed": bool(planner_metadata.get("llm_output_quality_passed")),
            "llm_planner_output_quality_issue_count": int(planner_metadata.get("llm_output_quality_issue_count") or 0),
